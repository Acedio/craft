...
enum ObjectType {OBJ_UNIT = 0x10,
	OBJ_UNIT_ARCHER = 0x10, 
	...
	OBJ_RESOURCE = 0x20,
	OBJ_RESOURCE_GOLD = 0x20, 
	OBJ_RESOURCE_TREE = 0x21, 
	OBJ_BUILDING = 0x40,
	OBJ_BUILDING_BARRACKS = 0x40, 
	OBJ_BUILDING_BLACKSMITH = 0x41, 
	OBJ_BUILDING_FARM = 0x42, 
	OBJ_BUILDING_KEEP = 0x43, 
	OBJ_BUILDING_LUMBERMILL = 0x44, 
	OBJ_BUILDING_WALL = 0x45 };
